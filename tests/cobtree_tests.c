...
void cobSanityCheck() {
    ...
    COB* cobtree = cobtreeCreate(serializer, serializer, cobIntKeyCompare, segmentSize, size);
...
void cobSpeed() {
    ...
    COB* cobtree = cobtreeCreate(serializer, serializer, cobKeyCompare, segmentSize, size);
